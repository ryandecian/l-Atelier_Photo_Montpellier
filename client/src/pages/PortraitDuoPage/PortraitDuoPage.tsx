...
function PortraitDuoPage() {
    const SEO = {
        title: "Service Portrait Duo et Couple - l'Atelier Photo Montpellier",
        autor: "Anne SAUNIER",
        description: "Offrez-vous un portrait de couple ou en duo pour célébrer votre lien unique. Séance photo professionnelle à Montpellier avec Anne SAUNIER.",

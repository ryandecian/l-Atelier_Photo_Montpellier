...
function dataSEO_PortraitMariage_data_SEO(): DataSEOTargetOne_Type {
    const dataSEO = {
        /* Data Helmet */
        ...
        name_Breadcrumb: "Portrait Mariage", /* Le libellé du lien dans le fil d’Ariane. Exemple : Portfolio ou Portrait Duo */
        name_Service: "Portrait Mariage - l'Atelier Photo Montpellier", /* Nom du service, utilisé dans le JSON-LD Service */
...
export { dataSEO_PortraitMariage_data_SEO };

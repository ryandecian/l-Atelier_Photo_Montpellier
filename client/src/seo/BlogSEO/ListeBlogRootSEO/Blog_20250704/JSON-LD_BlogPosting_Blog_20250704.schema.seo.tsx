...
function JSON_LD_BlogPosting_Blog_20250704_Schema_SEO() : string {
    ...
    const JSON_LD = JSON.stringify({
        ...
        /* Identifiants & URL */
        "@id": DataSEO_Blog_20250704.id_Service, /* @id SEO-friendly, correspond à l'URL de la page + mots clés */
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": DataSEO_Blog_20250704.url,
        },
        "url": DataSEO_Blog_20250704.url,

        /* Métadonnées principales */
        "headline": DataSEO_Blog_20250704.name_Service, /* Titre principal affiché par Google */
        "description": DataSEO_Blog_20250704.description, /* Description de l'article de blog */
        "keywords": extractKeywordsFromDataSEO(DataSEO_Blog_20250704.keywords), /* Extraction des mots clés */

        /* Image principale */
        "image": {
            "@type": "ImageObject",
            "url": DataSEO_Blog_20250704.img_JSON_LD, /* Lien URL public de l'image */
            "width": 1200,
            "height": 800
        },
...
export default JSON_LD_BlogPosting_Blog_20250704_Schema_SEO;

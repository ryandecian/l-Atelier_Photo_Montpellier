...
import { dataSEO_Blog_20250724_data_SEO } from "./dataSEO_Blog_20250724.data.seo";
...
function JSON_LD_BlogPosting_Blog_20250724_schema_SEO() : string {
    ...
    const JSON_LD = JSON.stringify({
        ...
        "keywords": extractKeywordsFromDataSEO_Utils(dataSEO_Blog_20250724.keywords), /* Extraction des mots clés */
...
export { JSON_LD_BlogPosting_Blog_20250724_schema_SEO };

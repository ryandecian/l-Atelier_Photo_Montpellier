...
function DataSEO_PortraitMariage(): DataSEOTargetOneType {
    const DataSEO = {
        ...
        img_JSON_LD: `${import.meta.env.VITE_DOMAIN_CLIENT}/images-seo/portrait-Mariage/google/photo-portrait-Mariage-professionnel-montpellier.jpg`, /*Lien URL public de l'image*/
        img_Helmet: `${import.meta.env.VITE_DOMAIN_CLIENT}/images-seo/portrait-Mariage/photo-portrait-Mariage-professionnel-montpellier.jpg`, /*Lien URL public de l'image*/
        id_Service: `${import.meta.env.VITE_DOMAIN_CLIENT}${ListDataRouter[13].path}#service-portrait-grossesse`, // @id SEO-friendly, correspond à l'URL de la page + mots clés

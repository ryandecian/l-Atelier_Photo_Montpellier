...
function DataSEO_PortraitCorporate(): DataSEOTargetOneType {
    const DataSEO = {
        ...
        name: "Portrait Corporate", /* Clé pour Breadcrumb qui est = à title sans le nom de l'entreprise */
        ...
        img_JSON_LD: `${import.meta.env.VITE_DOMAIN_CLIENT}/images-seo/portrait-corporate/google/lapm-photo-portrait-corporate-professionnel-montpellier-l-atelier-photo-montpellier`, /*Lien URL public de l'image*/
        img_Helmet: `${import.meta.env.VITE_DOMAIN_CLIENT}/images-seo/portrait-corporate/helmet/lapm-photo-portrait-corporate-professionnel-montpellier-l-atelier-photo-montpellier`, /*Lien URL public de l'image*/

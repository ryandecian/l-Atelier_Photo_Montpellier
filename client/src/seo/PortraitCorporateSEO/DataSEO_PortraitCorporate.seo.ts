...
function DataSEO_PortraitCorporate(): DataSEOTargetOneType {
    const DataSEO = {
        ...
        img_Helmet: `${import.meta.env.VITE_DOMAIN_CLIENT}/images-seo/portrait-corporate/photo-portrait-corporate-professionnel-montpellier.jpg`, /*Lien URL public de l'image*/
        id_Service: `${import.meta.env.VITE_DOMAIN_CLIENT}${ListDataRouter[11].path}#service-portrait-grossesse`, // @id SEO-friendly, correspond à l'URL de la page + mots clés

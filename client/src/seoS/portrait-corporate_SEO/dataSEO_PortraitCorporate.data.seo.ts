...
function dataSEO_PortraitCorporate_data_SEO(): DataSEOTargetOne_Type {
    const dataSEO = {
        /* Data Helmet */
        ...
        name_Breadcrumb: "Portrait Corporate", /* Le libellé du lien dans le fil d’Ariane. Exemple : Portfolio ou Portrait Duo */
        name_Service: "Portrait Corporate - l'Atelier Photo Montpellier", /* Nom du service, utilisé dans le JSON-LD Service */
...
export { dataSEO_PortraitCorporate_data_SEO };

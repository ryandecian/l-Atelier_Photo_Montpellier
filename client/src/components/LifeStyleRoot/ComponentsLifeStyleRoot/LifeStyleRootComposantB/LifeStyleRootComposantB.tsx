...
const services = [
    { id: 1, title: "Passion Live", name: "Portrait Hobbies", path: "/portrait-hobbies", img: img1 },
    { id: 2, title: "Moments Précieux", name: "Séance Famille", path: "/seance-famille", img: img2 },
    { id: 3, title: "Style Unique", name: "Mode & Lifestyle", path: "/mode-lifestyle", img: img3 },
    { id: 4, title: "Émotion Authentique", name: "Mariage & Engagement", path: "/mariage-engagement", img: img4 },
    { id: 5, title: "Instants Magiques", name: "Grossesse & Bébé", path: "/grossesse-bebe", img: img5 },
    { id: 6, title: "Corporate & Pro", name: "Portrait Professionnel", path: "/portrait-pro", img: img6 },
];

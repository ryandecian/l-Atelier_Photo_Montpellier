...
function QuiSuisJeRoot() {
  return (
    <section className={styleRoot.ContainerRootRacine}>
      <header className={styleRoot.ContainerTitle}>
        <h1 className={styleRoot.TitleH1}>
      ...
      <div className={css.TextContent}>
        ...
        <img
          ...
          className={css.FloatingImage}
        />
        <figcaption className={css.Caption}>Anne SAUNIER</figcaption>
        </div>
        ...
        <p className={styleRoot.TextP4}>
          ...
          <span className={styleRoot.SpanBold}> pour laquelle chaque photo devait être LA photo.</span>
        </p>
        ...
        <p className={styleRoot.TextP4}>
          ...
          <span className={styleRoot.SpanBold}> j’ai développé une expertise réelle dans ce domaine.</span>
        ...
        <p className={styleRoot.TextP4}>
          Aujourd'hui, <span className={styleRoot.SpanBold}>
        ...
        <p className={styleRoot.TextP4}>
          <span className={styleRoot.SpanLink}>
            <Link to="/tarifs">Découvrez mes prestations et trouvez celle qui vous correspond le mieux !</Link>
          </span>
        </p>
      </div>
    </section>

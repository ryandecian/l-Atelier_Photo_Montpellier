...
const Service: string = "Réservation Portrait Famille"; /* Bloc a modifier si besoin */
...
const dataRootEmail: DataRootEmailType = {
    essentiel: {
        ...
        body: `Bonjour Anne, %0D%0A %0D%0A Je souhaite réserver la formule ${Formule.essentiel} pour un portrait Famille. %0D%0A Pouvez-vous de me recontacter. %0D%0A %0D%0A Cordialement,`
    },
    confort: {
        mailto: externalLinks.emailAnne,
        subject: `${Service} - Formule ${Formule.confort}`,
        body: `Bonjour Anne, %0D%0A %0D%0A Je souhaite réserver la formule ${Formule.confort} pour un portrait Famille. %0D%0A Pouvez-vous de me recontacter. %0D%0A %0D%0A Cordialement,`
    },
    premium: {
        mailto: externalLinks.emailAnne,
        subject: `${Service} - Formule ${Formule.premium}`,
        body: `Bonjour Anne, %0D%0A %0D%0A Je souhaite réserver la formule ${Formule.premium} pour un portrait Famille. %0D%0A Pouvez-vous de me recontacter. %0D%0A %0D%0A Cordialement,`
    },
};

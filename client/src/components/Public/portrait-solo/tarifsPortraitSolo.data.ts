...
const tarifsPortraitSolo_Data: Prestation_Type = {
    essentiel: {
...
export { tarifsPortraitSolo_Data };

/* ---------- ----------- ---------- ---------- ---------- */
/* Bloc logique 2 */
/* Données modifiables pour les emails pré-remplies */

const service: string = "Portrait Solo";
...
const mailtoLinkPortraitSolo_Data: FormuleGroupe1_Type = {
...
export { mailtoLinkPortraitSolo_Data };

                ...
                <form onSubmit={handleSubmit} className={css.form}>
                    <div className={css.row}>
                        <div className={css.col}>
                            <label htmlFor="firstname" className={css.label}>Prénom</label>
                            <input
                                className={css.Input}
                                id="firstname"
                                type="text"
                        ...
                        <div className={css.col}>
                            <label htmlFor="lastname" className={css.label}>Nom</label>
                            <input
                                className={css.Input}
                                id="lastname"
                                type="text"
                    ...
                    <label htmlFor="password" className={css.label}>Mot de passe</label>
                    <input
                        className={css.Input}
                        id="password"
                        type="password"
                    ...
                    <label htmlFor="confirmPassword" className={css.label}>Confirmer le mot de passe</label>
                    <input
                        className={css.Input}
                        id="confirmPassword"
                        type="password"
                    ...
                    <label htmlFor="adress" className={css.label}>
                        Adresse <span className={css.optional}>(optionnel)</span>
                    </label>
                    <textarea

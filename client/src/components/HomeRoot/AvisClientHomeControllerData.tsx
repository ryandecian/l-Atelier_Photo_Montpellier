...
const AvisClientHomeControllerData: AvisClientControllerDataType[] = [
    /* Commentaire 1 */
    {
        id: 1,
        nom: "Ryan DECIAN",
        note: 5,
        commentaire: "J’ai eu le privilège de faire quelques photos avec Anne et j’ai été absolument ravi de l’expérience ! L’accueil était chaleureux, le professionnalisme au rendez-vous, et le shooting s’est déroulé dans une ambiance à la fois détendue et très professionnelle. Les photos sont magnifiques, d’une qualité exceptionnelle, et parfaitement mises en valeur. Si vous recherchez une photographe talentueuse, passionnée et à l’écoute, je recommande sans hésiter ! Encore merci pour ce superbe travail !",
        date: "10 mars 2025",
    },
    {
        id: 2,

...
import css from "./subMenuHomeMobile.module.css";
...
/* Import des Types */
import type { SubMenuNav_Type } from "../../../../../../types/layout/subMenuNav.type";

function SubMenuHomeMobile_Element({ dataMenu }: { dataMenu: SubMenuNav_Type }) {
    const [subMenuOpen, setSubMenuOpen] = useState(false);

    return (
        <li className={`SubMenuHomeMobile_Element ${dataMenu.nameMenu} ${css.MenuLiMobile}`} onClick={() => setSubMenuOpen(!subMenuOpen)}>
            <button
                type="button"
...
export { SubMenuHomeMobile_Element };

...
function sendMailerService(mailOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const sendMailer = yield mailer_1.default.sendMail(filterMailOption);
            return sendMailer;
        }
        catch (error) {
...
exports.default = sendMailerService;
